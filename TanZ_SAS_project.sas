...
DATE: Friday, January 09, 2015     TIME: 11:56:25 AM
...
PROC SQL;
   ...
   SELECT t1.DUPERSID, 
          ...
          t1.WLKLIM31, 
          t1.WLKLIM53
      FROM EC100013.meps_fullyr_2012 t1
      WHERE t1.AGE12X >= 18
...
/* -------------------------------------------------------------------
   ...
   Generated on: Friday, January 09, 2015 at 11:56:00 AM
...
PROC SQL;
	CREATE VIEW WORK.SORT AS
		SELECT T.ACTDTY31, T.ACTDTY42, T.ACTDTY53, T.ADAPPT42, T.ADCAPE42, T.ADCLIM42, T.ADCMPD42, T.ADCMPM42, T.ADCMPY42, T.ADDAYA42, T.ADDOWN42, T.ADDPRS42, T.ADDRBP42, T.ADEFRT42, T.ADEGMC42, T.ADEXPL42, T.ADEZUN42, T.ADFFRM42, T.ADFHLP42
		     ...
		     , T.ADPALS42, T.ADPRTM42, T.ADPRX42, T.ADPWLM42, T.ADRESP42, T.ADREST42, T.ADRISK42, T.ADRTCR42, T.ADRTWW42, T.ADSAD42, T.ADSMOK42, T.ADSOCA42, T.ADSPEC42, T.ADSPRF42, T.ADTLHW42, T.ADWRTH42, T.AGE12X, T.CANCERDX
		     , T.CHBRON31, T.CHBRON53, T.EDUYRDEG, T.EMPST31, T.EMPST42, T.EMPST53, T.ERTOT12, T.INSCOV12, T.K6SUM42, T.MARRY12X, T.MCDAT12X, T.MCS42, T.OTPAAT12, T.PCS42, T.PHQ242, T.PMEDPP31, T.PMEDPP42, T.PMEDPP53, T.PREVCOVR, T.PRIVAT12
		     , T.PRVEV12, T.PUBAT12X, T.RACETHX, T.REGION12, T.SEX, T.SFFLAG42, T.STPRAT12, T.TRIAT12X, T.TTLP12X, T.TYPEPE42, T.ANGIDX, T.ARTHDX, T.EMPHDX, T.LFTDIF31, T.LFTDIF53, T.PUBP12X, T.WLKDIF31, T.WLKDIF53, T.WLKLIM31, T.WLKLIM53
   ...
   SELECT t1.DUPERSID, 
          ...
          /* 4WKS:ACCMP_LESS_B/C_PHYS_PRBS */
            (CASE 
               ...
               ELSE t1.ADPALS42
            END) AS '4WKS:ACCMP_LESS_B/C_PHYS_PRBS'n, 
          ...
          /* YEAR OF EDUCATION/HIGHEST DEGREE */
            (CASE 
               ...
               ELSE t1.EDUYRDEG
            END) LABEL="Year of education or highest degree" AS 'YEAR OF EDUCATION/HIGHEST DEGREE'n, 
...
PROC SQL;
	CREATE VIEW WORK.SORTTempTableSorted AS
		SELECT T.MARRY12X, T."MARITAL STATUS"n
	FROM WORK.QUERY_FOR_MEPS_FULLYR_2012_SUBSE as T
;
QUIT;
TITLE;
...
PROC FREQ DATA = WORK.SORTTempTableSorted
	ORDER=INTERNAL
;
	TABLES MARRY12X * "MARITAL STATUS"n /
		NOROW
		NOCOL
		NOPERCENT
		MISSPRINT
...
/* -------------------------------------------------------------------
   ...
   Generated on: Friday, January 09, 2015 at 11:56:01 AM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Friday, January 09, 2015 at 11:56:02 AM
